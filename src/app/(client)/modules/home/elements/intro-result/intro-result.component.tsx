      ...
      <div className={'flex h-full w-full flex-col-reverse items-center gap-5 lg:flex-row lg:justify-between'}>
        <div className={'flex w-full max-w-[630px] flex-col gap-3 lg:gap-4'}>
          ...
          <div className={'mt-2 flex gap-3 max-sm:flex-col max-sm:px-4 lg:flex-row lg:gap-6'}>
            <button className='bg-primary hover:bg-primary-hover flex w-full max-w-[280px] items-center justify-center rounded-xl px-6 py-3 text-base font-medium text-white transition-colors max-sm:max-w-none sm:px-8 lg:w-auto'>
              <span>{t('home_page_iq_start_button')}</span>

              <ArrowRight size={16} className='ml-2' />
            </button>

            <button className='border-primary text-primary hover:bg-primary flex w-full max-w-[280px] items-center justify-center rounded-2xl border-2 px-6 py-3 text-base font-medium transition-colors hover:text-white max-sm:max-w-none lg:w-auto'>

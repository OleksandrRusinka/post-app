...
export const envClient = createEnv({
  client: {
    ...
    NEXT_PUBLIC_SENTRY_ENV: z.string().optional().or(z.literal('')),
    ...
    NEXT_PUBLIC_GROWTHBOOK_CLIENT_KEY: z.string().optional().or(z.literal('')),
    NEXT_PUBLIC_GROWTHBOOK_API_HOST: z.string().url().optional().or(z.literal('')),
  },
